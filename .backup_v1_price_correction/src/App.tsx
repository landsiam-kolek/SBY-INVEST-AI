...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-[#000000] text-slate-900 dark:text-[#E4E4E7] font-sans transition-colors duration-200 selection:bg-indigo-600 selection:text-white">
      {/* Navigation Header */}
      <Header
