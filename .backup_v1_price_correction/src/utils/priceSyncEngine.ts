...
export const REAL_MARKET_SNAPSHOT_PRESET: Record<string, { close: number; prevClose: number; change: number; changePercent: number }> = {
  // SET50 / Large Cap
  BANPU: { close: 14.50, prevClose: 14.50, change: 0.00, changePercent: 0.00 },
  KBANK: { close: 254.00, prevClose: 257.00, change: -3.00, changePercent: -1.17 },
  MTC: { close: 32.50, prevClose: 32.75, change: -0.25, changePercent: -0.76 },
  CPALL: { close: 46.75, prevClose: 46.75, change: 0.00, changePercent: 0.00 },
  DELTA: { close: 254.00, prevClose: 258.00, change: -4.00, changePercent: -1.55 },
  PTT: { close: 40.75, prevClose: 40.75, change: 0.00, changePercent: 0.00 },
  BDMS: { close: 19.90, prevClose: 19.80, change: 0.10, changePercent: 0.51 },
  ADVANC: { close: 360.00, prevClose: 358.00, change: 2.00, changePercent: 0.56 },
  SCB: { close: 152.00, prevClose: 151.50, change: 0.50, changePercent: 0.33 },
  BBL: { close: 190.00, prevClose: 189.50, change: 0.50, changePercent: 0.26 },
  ...
  GULF: { close: 64.00, prevClose: 63.75, change: 0.25, changePercent: 0.39 },
  ...
  PTTEP: { close: 149.50, prevClose: 150.00, change: -0.50, changePercent: -0.33 },
  ...
  PTTGC: { close: 24.80, prevClose: 25.20, change: -0.40, changePercent: -1.59 },
...
export function updateStockWithNewPrice(
  ...
  const prevClose = customPrevClose || stock.prevClosePrice || (stock.currentPrice - (stock.change || 0));
  ...
  return {
    ...
    actionPlanSummary: stock.actionPlanSummary.replace(
      ...
      `ราคาปิดล่าสุด (Last) ${price.toFixed(2)} บาท`
    ),
  };
}
